...
export function renderExperimentRunHelp(): string {
  return [
    ...
    "  --campaign <preset>                                 Real-agent campaign preset: codex-full, claude-full,",
    "                                                      codex-timeout-isolation. Selects Codex or Claude as the",
    "                                                      preset's single provider and requires --include-real-agents.",
    "                                                      The preset owns the bundled production corpus and project",
    "                                                      profiles; explicit --cases/--project-profiles and --target",
    "                                                      are rejected in campaign mode. --case and",
    "                                                      --benchmark-project narrow the preset's case set.",
    "                                                      Real-agent campaign execution is intentionally guarded and",
    "                                                      does not run in the current implementation stage.",
    "",
