...
- Active planned version: `v0.4.7` (declarative browser tutorial and video automation). The implementation is complete and documentation is reconciled; pre-release readiness is pending. The v0.4.7 implementation is not published. `v0.5.0` warm-index reuse remains the next experiment version after v0.4.7.
...
- Current branch: `feature/v0.4.7-browser-process-foundation` (v0.4.7 implementation-complete state; publication pending)
...
- Exact next action: run `v0.4.7` pre-release readiness with broad validation, cross-platform CI, security validation, and code-rot audit.
...
Run `v0.4.7` pre-release readiness with broad validation, cross-platform CI, security validation, and code-rot audit. Preserve v0.5.0 warm-index reuse unchanged as the next experiment version after v0.4.7.
