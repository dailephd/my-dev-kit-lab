...
The latest published release is v0.4.7 (declarative browser tutorial and video automation). It adds a generic declarative browser-tutorial runtime while preserving product-specific demo ownership outside this repository. Version v0.5.0 warm-index reuse is the next planned feature. See [CURRENT_STATE.md](CURRENT_STATE.md) for operational details, [CHANGELOG.md](../CHANGELOG.md) for release history, and [ROADMAP.md](ROADMAP.md) for future scope.
