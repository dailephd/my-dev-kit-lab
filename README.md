...
`v0.3.3` is the current published npm baseline, extending the previous baseline with Java/Kotlin analyzers, JVM metadata detection, Java/Kotlin detector support, and Java/Kotlin/Gradle/Maven docs-code-mismatch checks. Package metadata is `0.3.3`; `v0.3.2` remains the previous published baseline.
