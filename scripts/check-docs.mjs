...
for (const value of ["v0.4.0", "published", "v0.4.1", "nineteen", "CandidateEvidence", "zero Gradle", "zero external"] ) requireIn("README.md", value);
...
const forbidden = [
  ...
  [/v0\.4\.1[^\n]*(unreleased|implementation-complete but unreleased)/i, "claims released v0.4.1 is unreleased"],
...
if (pkg.version !== "0.4.1") failures.push(`package.json: expected released version 0.4.1, found ${pkg.version}`);
